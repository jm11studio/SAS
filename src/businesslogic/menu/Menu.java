...
public class Menu {
    ...
    public static Menu loadMenuID(int menuID) {
        ...
        PersistenceManager.executeQueryK(query, new ResultHandlerK() {
            ...
            public Task handle(ResultSet rs) throws SQLException {
                mn.setId( Integer.valueOf( rs.getString("id") ) );
                mn.setTitle( rs.getString("title") );
                mn.owner = User.loadUserById( Integer.valueOf( rs.getString("owner_id") ) );
                mn.published = Boolean.valueOf( rs.getString("published") );
    ...
    private void setId(int Cid) { id = Cid; }
